...
<body class="agileits_w3layouts">
    <h1 class="agile_head text-center"><?php if($username != ""): ?>
		<!-- html escaping  -->
	    ...
	    <form action="feedback.php" method="post" class="agile_form">
		  <h2>How satisfied were you with our Service?</h2>
			 <ul class="agile_info_select">
				 ...
				 <li><input type="radio" name="view" value="good" id="good" required> 
					  <label for="good"> good</label>
				      <div class="check w3ls"></div>
				 </li>
				 <li><input type="radio" name="view" value="neutral" id="neutral" required>
					 <label for="neutral">neutral</label>
				     <div class="check wthree"></div>
				 </li>
				 <li><input type="radio" name="view" value="poor" id="poor" required> 
